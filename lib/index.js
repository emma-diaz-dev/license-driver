...
if (params.l && _settings2.default.licenses[params.l.toUpperCase()]) {
  license = params.l.toUpperCase(), url = _settings2.default.licenses[license].url, regY = new RegExp(_settings2.default.licenses[license].regexp.y), regA = new RegExp(_settings2.default.licenses[license].regexp.a, 'g');
}
...
if (!useInternet) localTempalte();else (0, _licenseDriver.getLicense)(url).then(function (licText) {
  _fs2.default.writeFileSync('./lic-templates/' + license, licText, 'utf8');
